...
namespace AppointmentManagerBackEnd
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "AppointmentManagerBackEnd", Version = "v1" });
            });
            services.AddDbContext<CallManagerDbContext>(
                opt => opt.UseSqlite("DataSource=tesi_callmanager.db")
                ); ;
        }
